  ...
  return (
    <section>
      <article className="flex flex-col justify-center items-center gap-[1rem] max-w-[616px] mx-auto py-[3rem]">
        <h2
          className={`text-white leading-[2rem] md:leading-[3rem]  font-bold text-[1.625rem] md:text-[2.625rem] text-center ${plus_Jakarta_Sans.className}`}
        >
          Make every step user-centric
        </h2>
        <p
          className={`text-white font-[400] text-[0.975rem] md:text-[1.125rem] leading-[1rem] md:leading-[1.75rem] text-center ${plus_Jakarta_Sans.className}`}
        >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          <div className="flex justify-center items-center sm:border-r border-b h-[286.5px] border-[#E4E4E7]">
            <div className="flex flex-col gap-4 w-full max-w-[330px] h-[217px] p-4 justify-center items-center text-center">
              ...
              <h3
                className={`text-[1rem] md:text-[1.3125rem] text-white font-bold leading-[1.75rem] ${plus_Jakarta_Sans.className}`}
              >
                Global Sourcing
              </h3>
              <p
                className={`text-[0.875rem] md:text-[1rem]  leading-[18px] md:leading-[26px] text-white font-[400] ${plus_Jakarta_Sans.className}`}
              >
